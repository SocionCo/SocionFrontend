...
import { addAttachmentToCampaign, addInvoiceToCampaign, uploadAttachment } from "../../services/campaignServices";

const Input = styled('input')({
    display: 'none',
});

export default function UploadInvoiceForm ({ contractId, handleClose }) {
    ...
    const myForm = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            await addInvoiceToCampaign(invoiceDTO);
            handleClose();
        }
    });
    ...
    return (
        <Container maxWidth="sm">
            <Paper elevation={3} style={{ padding: "2em", marginTop: "2em" }}>
                <Typography variant="h4" align="center" gutterBottom>New Invoice</Typography>
